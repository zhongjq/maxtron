...
<div class="srbac">
  ...
  <table>
    ...
    <tr valign="top">
      <td colspan="2"><?php echo CHtml::activeDropDownList(AuthItem::model(),'name',
        Chtml::listData(AuthItem::model()->findAll('type=2'), 'name', 'name'),
        array('size'=>$this->module->listBoxNumberOfLines, 'name'=>Chtml::activeName(AuthItem::model(), 'taskname'),'class'=>'dropdown','ajax' => array(
        'type'=>'POST',
        'url'=>array('getTasks'),
        'update'=>'#tasks',
        'beforeSend' => 'function(){
