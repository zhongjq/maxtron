 ...
 */
  ...
  public function actionAssign() {
    ...
    $authItemName = isset($_POST['AuthItem']['taskname']) ? $_POST['AuthItem']['taskname'] : "";
  ...
  private function _getTheTasks() {
    ...
    $this->renderPartial('tabViews/roleAjax',
        array('model'=>$model,'taskname'=>$name,'data'=>$data,'message'=>$this->_getMessage()),false,true);
