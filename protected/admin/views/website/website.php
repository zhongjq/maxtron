	...
	<div id="usual1" class="usual">
		...
		<div id="tab2">
			...
			<table class="dataGrid" cellspacing="0">
				...
				<tr>
					<td>登记电子邮箱：</td><td><input type="text" name="register_email" id="register_email" class="long_input" value="<?php echo $rs['register_email']?>">
				<span class="clue_on"></span> </td>
				</tr>
				<tr>
					<td>应聘电子邮箱：</td><td><input type="text" name="resume_email" id="resume_email" class="long_input" value="<?php echo $rs['resume_email']?>">
				<span class="clue_on"></span> </td>
				</tr>
				<tr>
					<td>底部地址信息：</td><td>
