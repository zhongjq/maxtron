...
<?php
	...
	if($action == 'show' && $cate_name != '浮动广告')
		echo CHtml::linkButton('删除',array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure?'));
	if(($action == 'create' OR $action == 'update' OR $action == 'show') && $cate_name != '浮动广告')
