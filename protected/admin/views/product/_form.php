...
<?php echo CHtml::activeTextField($model,'summary',array('size'=>60,'maxlength'=>255)); ?>
</div>
<div class="simple">
...
<?php echo CHtml::activeLabelEx($model,'sellout'); ?>
<?php echo CHtml::activeCheckBox($model,'sellout',array('class'=>'vmiddel')); ?>
</div>
<div class="simple">
...
$(function(){
    $("#browseServer2").bind("click", function(){
        var finder2 = new CKFinder('/ckfinder/');
        finder2.selectActionFunction = SetFileField1;
        finder2.popup();
    });
});
