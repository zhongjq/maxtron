...
<div class="actionBar">
	<?php echo CHtml::beginForm('','GET'); ?>
		<div>
			分类:<?php echo CHtml::dropDownList('cate_id', Yii::app()->request->getParam('cate_id'), $this->cate_list);?>
			标题:<input type="input" name="title" value="<?php echo Yii::app()->request->getParam('title');?>" />
