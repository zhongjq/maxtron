...
<table class="dataGrid">
  ...
  <tr>
    ...
    <th><?php echo $sort->link('issuer'); ?></th>
    <th><?php echo $sort->link('icon'); ?></th>
    <th><?php echo $sort->link('url'); ?></th>
    <th><?php echo $sort->link('download'); ?></th>
...
<?php foreach($models as $n=>$model): ?>
  <tr class="<?php echo $n%2?'even':'odd';?>">
    ...
    <td><?php echo CHtml::encode($model->issuer); ?></td>
    <td><?php echo CHtml::link(CHtml::image($model->icon,$model->icon,array('class'=>ad_img_small)),$model->icon); ?></td>
    <td><?php echo CHtml::link($model->url); ?></td>
    <td><?php echo CHtml::link($model->download); ?></td>
