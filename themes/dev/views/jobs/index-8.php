...
<div class="new_products news_txt_top" style="width:95%; margin-left:15px;margin-top:15px;">
    <dl>
        ...
        <span style="margin-left:100px;"><?php echo $model->getAttributeLabel('createtime'); ?></span>
    	</dt>
    ...
    <?php foreach($models as $n=>$model): ?>
       ...
       <span style="margin-left:50px; width:20px;"><?php echo CHtml::encode($model->number); ?></span>
